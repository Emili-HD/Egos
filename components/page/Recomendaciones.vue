<template>
  <section class="accordion mb-40 col-[2_/_span_14] grid grid-cols-[repeat(16,_minmax(0,_1fr))] gap-0 xl:gap-4" v-for="competencias in data.listado_competencias" :key="competencias.id">
    ...
    <div class="list accordion__list col-[8_/_span_9] row-1">
      <div class="accordion__list--item flex flex-col flex-wrap justify-between py-6 cursor-pointer" v-for="listado in competencias.seccion_competencias" :key="listado.id">
        <div class="accordion__list--item-title flex flex-row justify-between items-center">
          <div class="max-w-[85%]" v-html="listado.titulo"></div>
