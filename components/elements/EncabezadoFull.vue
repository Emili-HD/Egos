<template>
  <header class="header full-width h-screen p-12 mb-0 col-[1/-1] lg:col-[1/12] !bg-transparent bg-cover bg-center" :style="`background-image: url(${data.featured_image_data.src});`">
  </header>
