<template>
    <div class="influencers-container flex items-start justify-center flex-wrap gap-4 p-12 lg:px-32 lg:pb-32">
        <h2 class="w-full text-center"><a href="https://instagram.com/clinicaegos/" target="_blank" rel="noopener noreferrer">@clinicaegos</a></h2>
        <div v-for="influencer in influencers" :key="influencer.url_del_enlace"
            class="influencer bg-white rounded-xl overflow-hidden w-full lg:w-[calc(33%-1rem)] xl:w-[calc(20%-1rem)] shadow-2xl">
