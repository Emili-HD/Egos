<template>
  ...
  >
    <h2 class="h5 text-nude-8 pb-6">{{ props.titulo }}</h2>
    <form @submit.prevent="handleSubmit" class="flex flex-col p-4  form-after">

      <div v-for="(group, groupIndex) in radioFieldGroups" :key="groupIndex" v-show="groupIndex === currentStep" class="step !relative">
      ...
      <div v-show="currentStep === radioFieldGroups.length" class="step-last [&_span]:text-2xl">
      ...
      <div class="flex justify-between">
        <div v-if="currentStep > 0">
          <button type="button" class="btn-blue text-white opacity-50 hover:opacity-100" @click="prevStep">Atrás</button>
        </div>
