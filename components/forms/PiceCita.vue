<template>
   <section class="pidecita" data-color="dark" data-header="dark">
      <div class="half-left">
         <ElementsGoogleMap @update-content="handleContentUpdate" @update-options="handleOptionsUpdate" />
      </div>
      <div id="formulario" class="half-right bg-blue1 p-12 rounded-xl h-full w-full mb-0 pt-24 absolute top-0">
         <div v-html="content"></div>
         <div class="form__wrapper p-2 p-xs-6">
