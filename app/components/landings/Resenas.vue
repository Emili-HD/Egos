                ...
                <div class="stars pb-4" :data-stars="comment.valoracion">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        ...
                        l-8.4-8.1l11.6-1.7L154.6,1.1z" stroke="#CCB780" />
                            ...
                            <rect class="bg-stars [clip-path:url(#SVGID_2_)] fill-gold-1" x="0.7" y="0.1"
                                :width="calculateWidth(comment.valoracion)" height="33.5" fill="#CCB780" />
                            <use xlink:href="#SVGID_1_"
                                style="overflow:visible;fill:none;stroke:#CCB780;stroke-miterlimit:10;" />
                        </g>
                    </svg>
                </div>
