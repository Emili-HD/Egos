        ...
        <form @submit.prevent="handleSubmit" class="mx-auto p-6 rounded space-y-4">
            ...
            <div class="flex items-start">
                ...
                <div class="ml-2 text-sm">
                    <label for="acceptMarketing" class="font-medium text-white">Acepto recibir otras comunicaciones de
                        Egos.</label>
                </div>
            </div>
            ...
            <div class="flex items-start">
                ...
                <div class="ml-2 text-sm">
                    <label for="acceptPrivacy" class="font-medium text-white">He leído y acepto la <a
                            href="https://www.clinicaegos.com/politica-de-privacidad/" target="_blank" rel="noopener"
                            class="underline">política de privacidad de Egos</a></label>
                </div>
                <span v-if="errors.acceptPrivacy" class="text-red-500 text-sm">{{ errors.acceptPrivacy }}</span>
            </div>

            <div>
                <button type="submit" :disabled="isSubmitting || formSubmitted" :class="buttonClass">
