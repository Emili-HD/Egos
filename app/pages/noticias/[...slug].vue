<template>
    <main class="site-main noticia bg-nude-8 grid grid-cols-16 min-h-[100vh] mb-0 gap-4" v-if="noticia">
        ...
        <aside
            ...
            <FormsEsteticaForm :identificador="'formulario'" :portalId="String(noticia.acf.formulario.portalid)"
                :formId="noticia.acf.formulario.formid" :name="noticia.title.rendered" class="lg:sticky lg:top-40" />
        </aside>
    </main>
</template>
