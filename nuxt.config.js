...
export default defineNuxtConfig({
    ...
    routeRules: {
        // '/?post_type=': { redirect: { to: '/', statusCode: 301 } },
        ...
        '/cirugia-mamaria/aumento-de-mamas-con-grasa-propia/': { redirect: { to: '/cirugia-de-pechos/aumento-de-pecho/', statusCode: 301 } },
        ...
        '/cirugia-capilar/injertos-capilares/': { redirect: { to: '/capilar/injerto-capilar/', statusCode: 301 } },
        '/injerto-capilar/injerto-capilar/': { redirect: { to: '/capilar/injerto-capilar/', statusCode: 301 } },
    ...
    nitro: {
        ...
        prerender: {
            routes: [
                ...
                '/medicina-estetica/eliminar-cicatrices/',
                '/medicina-estetica/aumento-de-labios/',
                '/medicina-estetica/tratamiento-antiarrugas/',
                '/medicina-estetica/relleno-de-ojeras/',
                '/medicina-estetica/tratamiento-de-morpheus-8/',
                '/medicina-estetica/presoterapia/',
                '/medicina-estetica/eliminar-arrugas-de-expresion/',
                '/medicina-estetica/marcacion-mandibular-medicina-estetica/',
                '/medicina-estetica/tratamiento-varices-sin-cirugia/',
                '/medicina-estetica/hidratacion-de-labios/',
                '/medicina-estetica/carboxiterapia/',
                // '/medicina-estetica/mesoterapia/',
                // '/medicina-estetica/mesoterapia-capilar/',
    ...
    vite: {
        ...
        build: {
            cssCodeSplit: false // Evita que Vite divida los CSS en archivos separados
        }
    },
