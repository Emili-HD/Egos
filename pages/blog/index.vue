<template>
  <main class="site-main blog bg-white" role="main" aria-label="Blog principal">
    <section class="blog mb-0" v-if="blogPage" aria-labelledby="page-title">
      <header
        class="blog__header section__header pt-40 grid grid-cols-16 min-h-[40vh] gap-y-8"
      >
        <h1
          class="blog__header-title text-center font-normal mb-0 col-[2/-2] lg:col-[4/-4]"
        >
          {{ blogPage.title.rendered }}
        </h1>
        <ElementsDivider class="mt-8 !mb-4 col-[2/-2] lg:col-[4/-4]" />
        <div
          class="blog__header-content text-center col-[2/-2] lg:col-[4/-4]"
          v-html="blogPage.content.rendered"
        ></div>
        <BlogPostDestacado />
      </header>
